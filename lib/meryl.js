 ...
 * operations through handlers and filters by chaining matched
...
function proc(infra, ctx, req, resp) {
  ...
  try {
    ...
    if (errorHandler) {
      errorHandler.call(ctx, req, resp, e);
    }
  }
}
...
Meryl.prototype = {
  ...
  cgi: function (opts) {
    var opts = opts || {};
    var infra = filters.concat(handlers);
    infra.push({
      pattern: "*",
      cb: notFoundHandler
    });
